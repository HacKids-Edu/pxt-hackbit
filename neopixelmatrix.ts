/**
 * Micro:Bit makeCode extension for neopixel/ws2812b matrix
 * 
 * 
 */
...
//% weight=10 color=#f04364 icon="\uf110" block="Hackbit NeoMatrix"
namespace HackbitNeoMatrix {
    ...
    export class Matrix {
        ...
        //% block.loc.pt-BR="mostrar %matriz"
        //% weight=90
        ...
        //% block.loc.pt-BR="definir brilho de %matriz para %setpoint"
        //% weight=80
        //% setpoint.defl=10
        //% blockGap=8 parts="NeoMatrix"
        ...
        //% block.loc.pt-BR="%matriz| definir pixel para x %x| y %y| para cor %colour"
        //% weight=80
        ...
        //% block.loc.pt-BR="%matriz desenhar bitmap %bitmap em x %x y %y | largura %width | altura %height | cor %colour | direção %direction"
        //% weight=100
    ...
    //% block.loc.pt-BR="matriz no pino %pin| largura %matrixWidth | altura %matrixHeight | modo %mode"
    //% weight=100
