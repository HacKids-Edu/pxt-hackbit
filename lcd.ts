 ...
 */
//% weight=9 color=#EEC51A icon="\uf0c9" block="Hackbit LCD"
...
namespace HackbitLCD {
   ...
   */
  //% subcategory="LCD2004"
  //% blockId="hackbit_lcd_show_string_on_2004"
  //% block="LCD2004 show %text | at position %startPosition=hackbit_lcd_position_2004 with length %length || and %option"
  //% text.shadowOptions.toString=true
   ...
   */
  //% subcategory="LCD1602"
  //% blockId=hackbit_lcd_position_1602
  //% block="%pos"
   ...
   */
  //% subcategory="LCD2004"
  //% blockId=hackbit_lcd_position_2004
  //% block="%pos"
  //% pos.fieldEditor="gridpicker"
