 ...
 * LCD chip SSD1306
 **/
//% weight=100 color=#F67D54 icon="\uf2c2" block="Hackbit OLED+" blockId="HackbitOLEDPlus"
...
namespace hackbit_VIEW128x64 {
    ...
    //% block.loc.pt-BR="atualizar display"
    //% weight=63 blockGap=8
    ...
    //% block.loc.pt-BR="inverter display %output=on_off_toggle"
